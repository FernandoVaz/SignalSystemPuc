...
clear; clc; close;
fa = 1000; Ta = 1/fa;
th = -1:Ta:1; P = length(th); %caminho do gráfico Tamanho do h(t)
tx = 2:Ta:3; Q = length(tx); %caminho do gráfico Tamanho do x(t)
N = P+Q-1;
...
h = 1-th; %th caminha de -1 até 1, somamos +1 para 
